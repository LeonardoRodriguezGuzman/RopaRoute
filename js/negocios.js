...
btnAceptar.addEventListener("click", () => {
  ...
  // Realizar la solicitud POST si todas las validaciones son correctas
  axios.post("http://localhost:3000/actualizarTienda", {
...
function cargarTiendas() {
  axios.post("http://localhost:3000/tiendas", {
...
function eliminar(id) {
  axios.post("http://localhost:3000/eliminarTienda", {
    id: id
  })
  .then(function (response) {
